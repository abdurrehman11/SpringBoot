...
public class TicketBookingDaoTest {
    ...
    public void testGetTicketById(){
        ...
        System.out.println(ticketFromInDb);
    ...
    public void testFindByEmail(){
        ...
        ticket.setDestStation("Delhi");
        ticket.setBookingDate(new Date());
        ticket.setEmail("martin.s2001@xyz.com");

        //Ticket in DB
        testEntityManager.persist(ticket);

        //Get ticket info from DB for specified email
        Ticket getFromDb = ticketBookingDao.findByEmail("martin.s2001@xyz.com");
        assertThat(getFromDb.getPassengerName()).isEqualTo("Martin");
    }
